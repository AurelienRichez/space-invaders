...
export class App {
     ...
     */
    run(duration_millis) {
        wasm.app_run(this.__wbg_ptr, duration_millis);
    }
    /**
     * @param {CanvasRenderingContext2D} ctx
     */
    draw(ctx) {
        const ret = wasm.app_draw(this.__wbg_ptr, ctx);
        if (ret[1]) {
    ...
    handle_key_down(keycode) {
        ...
        wasm.app_handle_key_down(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {string} keycode
     */
    handle_key_up(keycode) {
        const ptr0 = passStringToWasm0(keycode, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.app_handle_key_up(this.__wbg_ptr, ptr0, len0);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_space_invaders_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
